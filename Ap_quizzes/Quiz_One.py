...
"I would use addition is when setting a table. You need two pieces of the table to make a bigger table."
"I would use subtraction when using a motorcycle. I need to remove the damaged tire, therefore I am subtracting the two wheels by one."
"I would use multiplication when finding the solution in an algebraic expression (It tells me that the variable is 4 times greater than the present given number."
# 3. Describe the difference between camal case and pascal case.
"A camal case is when every word starts with a capital letter after the second word of a variable name"
"A Pascal case is when every word, including the first word, starts with a capital letter."
# 4. Which operator is being used in the example below
"The operator that is used is a variable"
numberOfApples = 10
numberOfOranges = 12
...
print("I am" + age)
allergy = input("What is your allergy")
print("my allergy is" + allergy)
